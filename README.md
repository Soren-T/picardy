...
## Demo
[Picardy Web Development](https://gatsby-starter-business.netlify.com)
...
```javascript
module.exports = {
  siteTitle: 'Picardy Web Development', // Site title.
  ...
  userDescription: '',
  copyright: 'Copyright © Picardy Web Development 2018. All Rights Reserved.', // Copyright string for the footer of the website and RSS feed.
